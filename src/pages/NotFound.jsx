...
export default function NotFound() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full animate-fade-in" style={{ padding: '2rem' }}>
      <div className="glass-panel text-center" style={{ padding: '3rem', maxWidth: '400px', width: '100%' }}>
        <div style={{ animation: 'pulse-dot 2s infinite' }}>
          <AlertTriangle size={64} className="mx-auto mb-4" style={{ color: 'var(--accent-warning)' }} />
        </div>
        <h1 style={{ fontSize: '2.5rem', marginBottom: '0.5rem', fontWeight: 'bold' }}>404</h1>
        <h2 style={{ fontSize: '1.125rem', marginBottom: '0.5rem', color: 'var(--text-secondary)' }}>Page Not Found</h2>
