...
function EngineeringDashboard() {
  ...
  if (!currentUser?.isDemo) {
    return (
      <EmptyState 
        ...
        description="Connect your application error tracking and tracing tools to view performance bottlenecks." 
      />
    );
  }
  ...
  return (
    <div className="flex-col gap-4" style={{ paddingBottom: '2rem' }}>
      ...
      {activeTrace && (
        <div 
          style={{ position: 'fixed', inset: 0, zIndex: 40, backdropFilter: 'blur(4px)', animation: 'fadeIn 0.3s ease forwards' }}
      ...
      >
        {activeTrace && (
          <>
            <div className="flex justify-between items-center" style={{ padding: 'var(--panel-padding)', borderBottom: '1px solid var(--border-color)', background: 'var(--bg-surface)' }}>
              <div>
                <h3 style={{ margin: 0 }}>Transaction Trace</h3>
            ...
            <div style={{ flex: 1, overflowY: 'auto', padding: 'var(--panel-padding)', display: 'flex', flexDirection: 'column', gap: 'var(--panel-gap)' }}>
              ...
              <div>
                ...
                <div style={{ background: '#1E1E1E', padding: 'var(--panel-padding)', borderRadius: 'var(--radius-md)', fontFamily: 'monospace', fontSize: '0.8rem', color: '#D4D4D4', overflowX: 'auto', border: '1px solid #333' }}>
              ...
              <div>
                ...
                <div style={{ padding: 'var(--panel-padding)', borderRadius: 'var(--radius-md)', fontFamily: 'monospace', fontSize: '0.8rem', border: '1px solid var(--border-color)' }}>
            ...
            <div style={{ padding: 'var(--panel-padding)', borderTop: '1px solid var(--border-color)', background: 'var(--bg-surface)', display: 'flex', justifyContent: 'flex-end', gap: '0.75rem' }}>
      ...
      <div className="flex justify-between items-center" style={{ marginBottom: '0.5rem' }}>
        <div>
          <h1 style={{ marginBottom: '0.125rem' }}>Engineering Investigation</h1>
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="glass-panel glow-card" style={{ '--card-color': '239, 68, 68', padding: 'var(--panel-padding)', display: 'flex', alignItems: 'center', gap: 'var(--panel-gap)' }}>
          <div style={{ padding: '0.75rem', borderRadius: 'var(--radius-md)' }}>
        ...
        <div className="glass-panel glow-card" style={{ '--card-color': '245, 158, 11', padding: 'var(--panel-padding)', display: 'flex', alignItems: 'center', gap: 'var(--panel-gap)' }}>
          <div style={{ padding: '0.75rem', borderRadius: 'var(--radius-md)' }}>
        ...
        <div className="glass-panel glow-card" style={{ '--card-color': '59, 130, 246', padding: 'var(--panel-padding)', display: 'flex', alignItems: 'center', gap: 'var(--panel-gap)' }}>
          <div style={{ padding: '0.75rem', borderRadius: 'var(--radius-md)' }}>
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="glass-panel col-span-2" style={{ padding: 'var(--panel-padding)', display: 'flex', flexDirection: 'column' }}>
          <h3 style={{ marginBottom: '1rem' }}>Failed Transactions</h3>
                ...
                {failedTransactions.map(tx => (
                  <tr key={tx.id} className="hover-bg-surface-hover" style={{ borderBottom: '1px solid var(--border-color)', transition: 'background-color 0.2s', cursor: 'pointer' }}>
                    <td style={{ padding: '0.75rem' }}>
                      <span style={{ fontFamily: 'monospace', padding: '0.2rem 0.4rem', borderRadius: '4px', fontSize: '0.75rem' }}>{tx.id}</span>
                    </td>
                    <td style={{ padding: '0.75rem' }}>
                    ...
                    <td style={{ padding: 'var(--panel-padding)', textAlign: 'right' }}>
        ...
        <div className="flex-col gap-4">
          <div className="glass-panel" style={{ padding: 'var(--panel-padding)' }}>
            <h3 style={{ marginBottom: '1rem' }}>Top Error Signatures</h3>
          ...
          <div className="glass-panel" style={{ padding: 'var(--panel-padding)' }}>
            <h3 style={{ marginBottom: '1rem' }}>Recent Error Screenshots</h3>
            <div className="grid grid-cols-2 gap-2" style={{ marginTop: '0.5rem' }}>
              {[1,2,3,4].map(num => (
                <div key={num} style={{ borderRadius: 'var(--radius-sm)', minHeight: '6.25rem', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '0.7rem', color: 'var(--text-muted)', position: 'relative', overflow: 'hidden', cursor: 'pointer' }}
                  onMouseEnter={(e) => {
                ...
                >
                  ...
                  <div className="overlay" style={{ position: 'absolute', inset: 0, opacity: 0, transition: 'opacity 0.2s', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
